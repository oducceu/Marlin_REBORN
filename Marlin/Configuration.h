...
#define STRING_CONFIG_H_AUTHOR "(Serg Panin, Flying Bear REBORN)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 2.84
  #define DEFAULT_bedKd 139.40
