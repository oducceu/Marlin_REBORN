...
#define STRING_CONFIG_H_AUTHOR "(ODUCCEU, FB_Reborn)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 73.25
  #define DEFAULT_bedKi 13.27
  #define DEFAULT_bedKd 269.55
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 12, 70 } // ...or, set your own edit limits
#endif
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 45, 42.5, 45, 42.5 } // (mm) Left, Front, Right, Back insets
